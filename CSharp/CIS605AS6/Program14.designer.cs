namespace MClarkAS6
{
    partial class Program14
    {
        ...
        /// </summary><DirectedGraph xmlns="http://schemas.microsoft.com/vs/2009/dgml">
  /*
  <Nodes>
    <Node Id="(@1 @2)" Visibility="Hidden" />
    <Node Id="(@3 Namespace=CIS605AS6 Type=Program14)" Category="CodeSchema_Class" CodeSchemaProperty_IsPublic="True" CommonLabel="Program14" Icon="Microsoft.VisualStudio.Class.Public" IsDragSource="True" Label="Program14" SourceLocation="(Assembly=file:///C:/Users/marys/source/repos/CIS605AS6/Program14.designer.cs StartLineNumber=2 StartCharacterOffset=18 EndLineNumber=2 EndCharacterOffset=27)" />
  </Nodes>
  <Links>
    <Link Source="(@1 @2)" Target="(@3 Namespace=CIS605AS6 Type=Program14)" Category="Contains" />
  </Links>
  <Categories>
  ...
  <IdentifierAliases>
    <Alias n="1" Uri="Assembly=$(VsSolutionUri)/MClarkAS6.csproj" />
    <Alias n="2" Uri="File=$(VsSolutionUri)/Program14.designer.cs" />
    <Alias n="3" Uri="Assembly=$(b808dbe8-09cf-4e50-8e74-1a4e446e45c6.OutputPathUri)" />
  </IdentifierAliases>
  <Paths>
    <Path Id="b808dbe8-09cf-4e50-8e74-1a4e446e45c6.OutputPathUri" Value="file:///C:/Users/marys/source/repos/CIS605AS6/bin/Debug/CIS605AS6.exe" />
    <Path Id="VsSolutionUri" Value="file:///C:/Users/marys/source/repos/CIS605AS6" />
  </Paths>
</DirectedGraph>
*/
        ...
        private void InitializeComponent()
        {
            ...
            this.txtPrices.Location = new System.Drawing.Point(196, 107);
