...
namespace MClarkAS6
{
    public partial class Program15 : Form
    {
        ...
        {
            List<int> myList = aCard.CalcStatusAfterHole((int)nudRound.Value).ToList();
            lstAfterHoleStatus.DataSource = myList;
        }
        ...
        {
            lblAverageScore.Text = aCard.CalcAverageScoresByPar((int)nudPar.Value).ToString("n2");
