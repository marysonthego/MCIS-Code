...
namespace MClarkAssignmentSet3
{
    public class Walk
    {
        ...
        /*
         * Constructor for a Walk object. The NameOfTheWalker, TotalStepsTaken, and AverageLengthOfAStepInInches are required.
         */
        public Walk(string NameOfTheWalker, int TotalStepsTaken, int AverageLengthOfAStepInInches)
        {
            WalkerName = NameOfTheWalker;
            NumberOfSteps = TotalStepsTaken;
            LengthOfSteps = AverageLengthOfAStepInInches;
        }

        /* 
         * The public method CalcMilesWalked returns the number of miles walked for this Walk instance.
         */
        public double CalcMilesWalked()
        {
